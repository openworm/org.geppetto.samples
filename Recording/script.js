Simulation.setWatchedVariables([purkinje.electrical.SimulationTree.P.neuron0.gi, purkinje.electrical.SimulationTree.P.neuron0.ge]);
Simulation.start();
...
VarVis1.setVariable(purkinje.electrical.SimulationTree.P.neuron0.gi);
